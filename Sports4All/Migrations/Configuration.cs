namespace Sports4All.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Sports4All.ModelContext>
    {
        ...
        protected override void Seed(Sports4All.ModelContext context)
        {
            ...
            listDistricts.Add(new District() { DistrictId = 2, Name = "Acores" });

            ICollection<County> listCounties = new Collection<County>();

            listCounties.Add(new County() { CountyId = 1, DistrictId = 2, Name = "Machico" });
            ...
            listPictures.Add(new Picture() { PictureId = 1, PictureBody = "user1" });
            ...
            listPictures.Add(new Picture() { PictureId = 7, PictureBody = "ground1" });
            listPictures.Add(new Picture() { PictureId = 8, PictureBody = "park1" });
            listPictures.Add(new Picture() { PictureId = 9, PictureBody = "park2" });
            ...
            //listUsers.Add(new User() { PictureId = listPictures.First().PictureId, Username = "rubinol0uco", Age = 23, Email = "rubino@gmail.com", Password = "123", PhoneNumber = 961451339, CountyId = listCounties.ToList()[2].CountyId });
            //            listUsers.Add(new User() { PictureId = listPictures.First().PictureId, Username = "rafaela33", Age = 23, Email = "rubino@gmail.com", Password = "123", PhoneNumber = 961451229, CountyId = listCounties.ToList()[2].CountyId });
            //            listUsers.Add(new User() { PictureId = listPictures.First().PictureId, Username = "michaelfx", Age = 23, Email = "michaelDal@gmail.com", Password = "123", PhoneNumber = 926456783, CountyId = listCounties.ToList()[3].CountyId });
